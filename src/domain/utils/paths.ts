...
export const BASE_CARD_IMAGE = resolve(
    __dirname,
...
export const DIRT = resolve(
    __dirname,
    '../../../assets/cards/card_image_borders.png',
)
export const CARD_OVERLAY = resolve(
    __dirname,
    '../../../assets/cards/card_overlay.png',
)
export const DEFAULT_IMAGE = resolve(__dirname, '../../../assets/ryoshu.jpg')
export const DEFAULT_FONT = resolve(
    __dirname,
    '../../../assets/fonts/converted/test.fnt',
)
